...
class RobustKT(BaseKt):
    ...
    def forward(self, x, mask=None, training=None, **kwargs):
        ...
        if self.n_pid > 0:
            ...
            if self.separate_qa:
                qa_embed_diff_data = self.qa_embed_diff(q_data + self.n_question * target)
...
class Architecture(nn.Module):
    def __init__(self, n_blocks, d_model, d_ff, n_heads, dropout, kq_same, emb_type, ks):
        super().__init__()
